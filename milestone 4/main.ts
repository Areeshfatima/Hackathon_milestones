...
const myForm2= document.getElementById ("resume") as HTMLFormElement;

const myResume2 = document.getElementById ("display-resume") as HTMLDivElement;

// Get UserGenerate Resume Form

myForm2.addEventListener ("submit" , (event : Event) => {
    ...
    if(myResume2) {
        myResume2.innerHTML = getResume2;
    }
    else {
